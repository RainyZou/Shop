							...
							<c:forEach var="product" items="${pList}">
								<tr>
									<td><input type="checkbox" name="ids"
										value="${product.id }" /></td>
									<td><a href="product/admin/add?id=${product.id}"><img alt="" src="${product.defaultPicturePath }"
										class="img-circle" style="width: 80px; height: 80px"></a></td>
									<td><a href="product/admin/add?id=${product.id}">${product.name }</a></td>
									<td>折后价：${product.currentPrice }<br>现价：<span
										class="deleteline">${product.standardPrice }</span></td>
